...
function ProductDetail() {
  ...
  return productData ? (
    <div >
     ...
     Upgrade your outfit with this stylish embroidery design, available now on BearAndBond. Crafted with premium-quality stitching, it offers long-lasting beauty and a perfect finish. Easy to maintain and ideal for any occasion, this design is a must-have for those who value both style and craftsmanship.</p>
     </div>
