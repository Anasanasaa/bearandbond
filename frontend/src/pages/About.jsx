      ...
      <div className='w-[100%]  flex items-center justify-center flex-col lg:flex-row'>
        ...
        <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px]  flex-col mt-[20px] lg:mt-[0px]'>
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
            BearAndBond was born for smart, seamless embroidery—created to deliver premium designs, trending patterns, and custom essentials in one place. With reliable craftsmanship, fast delivery, and great value, BearAndBond makes your embroidery experience simple, satisfying, and stress-free.
          </p>
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
             Made for modern customers—combining style, comfort, and premium embroidery. Whether it’s custom designs, trendy patterns, or elegant detailing, we bring everything you need to one trusted platform with fast delivery, easy support, and a customer-first experience you’ll love.
          </p>
          <p className='lg:w-[80%] w-[100%] text-[15px] text-[white] lg:text-[18px] mt-[10px] font-bold'>Our Mission</p>
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
           Our mission is to redefine embroidery shopping by delivering quality, affordability, and convenience. BearAndBond connects customers with trusted designs and craftsmanship, offering a seamless, customer-focused experience that saves time, adds value, and fits every style and need.
          </p>
        </div>
      </div>
